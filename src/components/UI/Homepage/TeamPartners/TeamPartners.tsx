...
const TeamPartners = () => {
  return (
    <Container className="mt-10 lg:mt-32 mb-10 lg:mb-20">
      <Heading
        title="TEAM PARTNERS"
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-0 mt-6 md:mt-6">
        <div className="relative border-gray-300 mr-4 ">
          ...
          <div className="hidden md:block absolute top-[20px] right-0 h-[calc(100%-40px)] w-[2px] bg-[#E5E5E5]"></div>
        </div>
        <div className="border-gray-300 hidden md:block">
        ...
        <div className="relative border-gray-300 mr-4 hidden md:block">
          <div className=" border-b-2 border-gray-300 mr-5">
            <div>
              <h3 className="text-primary text-2xl font-semibold text-center mt-5 uppercase">
                Associate Sponsor
              </h3>
